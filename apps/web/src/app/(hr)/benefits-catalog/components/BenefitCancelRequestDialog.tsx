...
export default function BenefitCancelRequestDialog({
  ...
  return (
    ...
    >
      <div className="flex max-h-[250px] w-full max-w-[462px] flex-col box-border rounded-[12px] border border-[#CBD5E1] bg-white px-[31px] py-8 shadow-[0_20px_45px_rgba(0,0,0,0.2)]">
