...
type RuleCancelRequestDialogProps = {
...
export default function RuleCancelRequestDialog({
  currentUserIdentifier,
  onCancelled,
  onClose,
  requestId,
}: RuleCancelRequestDialogProps) {
  ...
  return (
    ...
    >
      <div className="flex max-h-[250px] w-full max-w-[462px] flex-col rounded-[12px] border border-[#CBD5E1] bg-white px-[31px] py-8 shadow-[0_20px_45px_rgba(0,0,0,0.2)]">
        <div className="flex w-full flex-col items-center gap-8">
          <div className="flex w-[414px] max-w-full flex-col items-center gap-2 self-center">
            ...
            <p className="w-full text-center text-[14px] leading-5 text-[#64748B]">
              This pending rule request will be cancelled and reviewers will no
