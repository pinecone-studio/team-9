...
function RuleCardSkeleton() {
  return (
    <div className="flex h-[196px] w-full animate-pulse flex-col gap-[14px] rounded-[8px] border border-[#DBDEE1] bg-white p-4 xl:max-w-[420px]">
      <div className="h-6 w-3/5 rounded bg-[#E8EDF2]" />
      <div className="space-y-2">
        <div className="h-4 w-full rounded bg-[#EEF2F6]" />
        <div className="h-4 w-4/5 rounded bg-[#EEF2F6]" />
      </div>
      <div className="h-6 w-24 rounded-[6px] bg-[#F1F5F9]" />
      <div className="mt-auto flex items-center justify-between border-t border-[#EDEFF0] pt-[14px]">
        <div className="h-4 w-24 rounded bg-[#EEF2F6]" />
        <div className="h-7 w-20 rounded-[6px] bg-[#F1F5F9]" />
      </div>
    </div>
  );
}
      ...
      {sectionMeta.map((section, index) => (
        <div key={section.title} className="flex w-full flex-col items-start gap-6">
          ...
          <div className="flex w-full flex-wrap items-center gap-5">
            ...
            <div className="w-full lg:w-[calc(50%-10px)] xl:w-[420px]">
              <div className="flex h-[196px] w-full animate-pulse flex-col items-center justify-center rounded-[8px] border-2 border-dashed border-[rgba(219,222,225,0.6)] bg-white xl:max-w-[420px]">
