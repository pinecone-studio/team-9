...
export function DetailCard({
  ...
  return (
    <div
      className={`rounded-[10px] border border-[#E5E5E5] bg-[rgba(245,245,245,0.3)] p-4 ${className}`.trim()}
    >
      {children}
    </div>
  );
  ...
  return (
    <DetailCard className="p-3">
      ...
      <div className="flex items-center gap-3">
        <div className="flex-1 rounded-[4px] border border-[#FFC9C9] bg-[#FEF2F2] px-3 py-2 text-[14px] leading-5 text-[#C10007] line-through">
          {previousValue}
        </div>
        <ArrowRight className="h-4 w-4 shrink-0 text-[#737373]" />
        <div className="flex-1 rounded-[4px] border border-[#B9F8CF] bg-[#F0FDF4] px-3 py-2 text-[14px] leading-5 text-[#008236]">
          {nextValue}
        </div>
      </div>
    </DetailCard>
